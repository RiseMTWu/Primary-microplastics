# -*- coding: utf-8 -*-
"""
Created on Tue Jul  1 10:41:52 2025
...
data = pd.read_csv(r"../2019_MFs_dataset.csv",encoding="GBK")
print(data.shape) #3060,38
...
for adjustment in adjustments:
    ...
    #data_input["population"] = data["population"] * adjustment
    #data_input["synthetic fibers"] = data["synthetic fibers"] * adjustment
    data_input["EF-MW"] = data["EF-MW"] * adjustment
    ...
    city.to_csv("../MFs_EF_{}.csv".format(adjustment), index=True)  