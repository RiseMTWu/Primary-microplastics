# -*- coding: utf-8 -*-
"""
Created on Tue Jul  1 09:32:51 2025
...
for year in range(2020, 2036):
    print(year)
    filename = f'../TWP_{year}reduce1.csv'
    #filename = f'TWP_{year}reduce2.csv'
    #filename = f'TWP_{year}reduce3.csv'
    ...
    city.to_csv("../TWP_{year}result_reduce1.csv", index=True)  
    # city.to_csv("../TWP_{year}result_reduce2.csv", index=True) 
    # city.to_csv("../TWP_{year}result_reduce3.csv", index=True) 
#%%
#######################################  MFs
import pandas as pd
import numpy as np
...
for year in range(2020, 2036):
    ...
    filename = f'../MFs_{year}reduce1.csv'
    ...
    city.columns = data_input['City']
    city.to_csv("../MFs_{year}result_reduce1.csv", index=True)     
