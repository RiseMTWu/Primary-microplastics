# -*- coding: utf-8 -*-
"""
Created on Tue Jul  1 10:47:15 2025
...
data = pd.read_csv(r"../dataset/2019_PMs_dataset.csv",encoding="GBK")
print(data.shape) 
para_df = pd.read_csv(r"../PMs_para_score.csv",encoding="GBK")
score_mapping = dict(zip(para_df['Parameters'], para_df['Score']))

#columns_to_adjust = ['Consumption-yagao', 'Consumption-myl', 'Consumption-msg', 'Consumption-xmn']
columns_to_adjust = ['EF-yagao', 'EF-myl', 'EF-msg', 'EF-xmn']
#columns_to_adjust = ['PMs-yagao', 'PMs-myl', 'PMs-msg', 'PMs-xmn']
...
for adjustment in adjustments:
    ...
    city.to_csv("../PMs_EF_{}.csv".format(adjustment), index=True)  
#%%
########################      TC
import pandas as pd
import numpy as np
...
warnings.filterwarnings('ignore')
data_input = pd.read_csv(r"../PMs_remove_1.3.csv",encoding="GBK")
...
city.columns = data_input['City']
city.to_csv("../PMs_remove_1.3_results.csv", index=True) 